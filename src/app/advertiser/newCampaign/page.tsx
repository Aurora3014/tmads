...
import { Button, Table, Tooltip, TableProps, Tag, Input, Radio, Space, Checkbox, InputNumber, Upload, notification, Divider, message } from 'antd'
            ...
            <div className='flex flex-row justify-between'>
                ...
                <div className='items-center justify-center mt-10'>
                    <div className="w-[360px] h-[650px] tg_bg flex items-center justify-center p-16 rounded-[20px]">
                        <AdCard title={title} description={description} image={imageUrl}/>
                    </div>
                </div>
            </div>
        </div>
